...
class Ladgerpayment_in extends Controller
{
    ...
    public function search(Request $req)
        ...
        $data['statement'] = DB::select("select * from payment_statement join ladgers on ladgers.account_id = payment_statement.ladger_id where payment_statement.ladger_id = '$acc_id' AND cr_amt > 0");

        return view('payment_in/table',$data);
