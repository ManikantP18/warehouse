...
<div class="d-flex">
   ...
   <a href="#" data-size="xl" data-url="{{ route('payment_in.create') }}" data-ajax-popup="true"
        data-bs-toggle="tooltip" title="{{ __('Create') }}" data-title="{{ __('Create Payment In') }}"
...
<div class="row">
    <div class="card mt-4">
        <div class="card-body">
            <h5 class="mb-5">Payment In List</h5>
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $row->amount ?? '0' }}</td>
                            <td>{{ $row->created_date ? \Carbon\Carbon::parse($row->created_date)->format('d-m-Y') : 'N/A' }}</td>
                        </tr>
                        @empty
                        <tr>
