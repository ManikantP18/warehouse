            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="col-12 m-auto">
                        <div class="row align-items-end m-auto form-group ">
                            <div class=" col-md-6 form-icon-user allfarmers"></div>
...
@push('script-page')
    <script>
        ...
        function selectLadger(id) {
            $.get('{{ route('payment_in.history') }}', { searchVal: id }, function(response) {
