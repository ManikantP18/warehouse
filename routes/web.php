...
Route::get('/gredding/edit/{id}', 'App\Http\Controllers\GreddingController@edit')->name('gredding.edit')->middleware('auth');
Route::put('/gredding/update/', 'App\Http\Controllers\GreddingController@update')->name('gredding.update')->middleware('auth');
...
Route::group(['middleware' => ['verified']], function () {
    ...
    Route::group(
        ...
        function () {
            ...
            Route::resource('ladger', LadgerController::class)->except('show');

            Route::get('ladger/{id}/show', [LadgerController::class, 'show'])->name('ladger.show');
        }
    );
    Route::group(
        [
